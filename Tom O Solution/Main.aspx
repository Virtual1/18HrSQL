       ...
       <asp:DropDownList 
        ...
        <div id="dvDiv" 
            ...
            <asp:CheckBox
                ...
                Checked="false"
                runat="server" 
                OnCheckedChanged="chkDetailsView_CheckedChanged" />
            Show Details
                ...
                <ContentTemplate>
                    <asp:Panel 
                        ...
                        <asp:GridView 
                            ...
                            DataSourceID="sqlSummarySalesTable">
                            <Columns>
                                <asp:TemplateField 
                                    ...
                                    <ItemTemplate>
                                        <asp:Label 
                                            ID="Label1" 
                                            runat="server" 
                                            Text='<%# Bind("Column1", "{0:C}") %>'></asp:Label>
                                    </ItemTemplate>
                                </asp:TemplateField>
                                <asp:BoundField 
                                    DataField="EmpID" 
                        ...
                        <asp:SqlDataSource 
                            ID="sqlSummarySalesTable" 
                            runat="server" 
                            ConnectionString="<%$ ConnectionStrings:mydbaseConnectionString %>" 
                            SelectCommand=" select sum(Amount), EmpID from SalesTable 
                                            where EmpID=@EmpID group by EmpID">
                            <SelectParameters>
                                <asp:ControlParameter 
                                    ControlID="dvEmployees" 
                                    Name="EmpID" 
                        ...
                        <div id="SalesDiv">
                            ...
                            AutoGenerateColumns="False" 
                                DataKeyNames="ID" 
                                DataSourceID="salesTableDataSource" 
                                AllowPaging="True" 
                                AllowSorting="True" 
                            ...
                            <Columns>
                                ...
                                <asp:BoundField 
                                    DataField="MonthOnly" 
                                    HeaderText="MonthOnly" 
                                    SortExpression="MonthOnly" />
                                <asp:TemplateField 
                                    HeaderText="Amount" 
            ...
            <asp:SqlDataSource
                ...
                runat="server" ConnectionString="<%$ ConnectionStrings:mydbaseConnectionString %>" 
                DeleteCommand="DELETE FROM [EmployeesTable] WHERE [EmpID] = @EmpID" 
                InsertCommand="INSERT INTO [EmployeesTable] ([FirstName], [LastName]) VALUES (@FirstName, @LastName)" 
                SelectCommand="SELECT [EmpID], [FirstName], [LastName] FROM [EmployeesTable]"
                UpdateCommand="UPDATE [EmployeesTable] SET [FirstName] = @FirstName, [LastName] = @LastName 
                WHERE [EmpID] = @EmpID">
                <DeleteParameters>
            ...
            <asp:SqlDataSource 
                ID="salesTableDataSource" 
                runat="server" 
                ConnectionString="<%$ ConnectionStrings:mydbaseConnectionString %>" 
                DeleteCommand="DELETE FROM [SalesTable] WHERE [ID] = @ID" 

                InsertCommand="INSERT INTO [SalesTable] 
                ([EmpID], [DateSold], [MonthOnly], [Amount]) VALUES (@EmpID, @DateSold, @MonthOnly, @Amount)" 

                SelectCommand="SELECT [ID], [EmpID], [DateSold], [MonthOnly], [Amount] 
                FROM [SalesTable] WHERE ([EmpID] = @EmpID)" 

                UpdateCommand="UPDATE [SalesTable] SET [EmpID] = @EmpID, 
                [DateSold] = @DateSold, [MonthOnly] = @MonthOnly, [Amount] = @Amount WHERE [ID] = @ID">
                <DeleteParameters>
